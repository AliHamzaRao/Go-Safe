...
export const routes: Routes = [
    { 
        ...
        data: { breadcrumb: 'Dashboard' },resolve:{model:VehicleListResolver},
        children: [
    ...
    { 
        ...
        canActivate:[AuthGuard],
        canActivateChild:[AuthGuard],
        data: { breadcrumb: 'Asset Trip Report' },resolve:{model:VehicleListResolver},
        children: [
            { path: '', loadChildren: () => import('./routes/Assets/asset-trip-report/asset-trip-report.module').then(m => m.AssetTripReportModule)},
        ],
    },
