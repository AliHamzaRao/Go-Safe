...
export const verticalMenuItems = [ 
    new Menu (1, 'Live Tracking', '/', null, 'dashboard', null, false, 0),
    new Menu (2, 'Geo-fence', '/', null, 'place', null, true, 0),
    new Menu (3, 'Create Geo-fence', '/', null, 'my_location', null, true, 2),
    new Menu (4, 'Push Notification Logs', '/', null, 'alarm_on', null, true, 0),
    new Menu (5, 'Videos', '/', null, 'subscriptions', null, true, 0),
    ...
    // new Menu (201, 'Accounts',null, null, 'computer', null, true, 0),
    // new Menu (202, 'manage it', '/account', null, 'short_text', null, false, 201),    
]
