...
export class PacketParser {
        ...
        public constructor (p_data: string) {
            ...
            if ((this.veh_id > 0)) {
                if ((alarms != "")) {
                    this.almPriority.toString() + "<#>" + this.almSrNo.toString() + "<#>" + this.almRecDateTime.toString() + "<#>" + this.almGpsDateTime.toString() + "<#>" + this.alarmDesc  + "<#>" + this.almSpeed + "<#>" + this.almLocation + "<#>" + this.alarmID;
                    let ArrAlm: string[] = alarms.split("<#>");
                    if ((ArrAlm.length >= 8)) {
                        this.almPriority = parseInt(ArrAlm[i++]);
                        this.almSrNo = parseInt(ArrAlm[i++]);
                        this.almRecDateTime =new Date(ArrAlm[i++]);
                        this.almGpsDateTime =new Date(ArrAlm[i++]);
