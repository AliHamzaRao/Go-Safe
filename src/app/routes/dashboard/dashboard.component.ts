...
export class DashboardComponent implements OnInit {
  ...
  img:any;
  //#region Constructor
  constructor(private dashboardSer: dashboardService, private router: Router, public route: ActivatedRoute, public appSettings: AppSettings, public dialog: MatDialog) {
